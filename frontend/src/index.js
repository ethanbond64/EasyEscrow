    ...
    <footer class="bg-white">
      <div class="mx-auto w-full container p-4 sm:p-6">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">2023 <a href="https://localhost:3000" class="hover:underline">Easy Escrow</a>. All Rights Reserved.
          </span>
