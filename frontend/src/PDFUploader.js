  ...
  return (
    <div className='relative m-auto flex h-2/3 p-2.5 pb-4 rounded shadow-md w-1/3 bg-slate-100'>
      <form onSubmit={handleSubmit} className='w-full'>
        <label for="dropzone-file" className="flex flex-col items-center justify-center w-full h-5/6 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 ">
